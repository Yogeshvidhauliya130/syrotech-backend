...
{ name: "Shekhar Rana", email: "shekhar.rana@syrotech.com", password: "shekhar123", specialization: ["OLT","ONT","EMS/NMS"], level: 1, zone: "all except south", city: "", country: "India", phone: "" },
...
{ name: "Naman  Gupta", email: "naman.gupta@goip.in", password: "naman@1112", specialization: ["Lockin ONT", "Lockin OLT","Firewall/SDWAN","Anroid Box"], level: 3, zone: "all", city: "", country: "India", phone: "" },
...
if (typeFilterParam === "logistic") {
  filter.ticketType = "logistic";
}
if (typeFilterParam === "product") {
  filter.source = { $nin: ["hr", "hradmin"] };
  filter.ticketType = { $nin: ["lockin", "product_testing", "rnd", "logistic"] };
}
   if (source) {
  if (source === "sales") {
